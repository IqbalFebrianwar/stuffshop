    ...
    return (
        <div className="navbar bg-base-100 px-48">
            <div className="flex-1">
                <Link href="/" className="btn btn-ghost text-xl rounded-xl">
                    StuffShop
                </Link>
            </div>
                ...
                <form onSubmit={onSubmitSearching}>
                    <div className="form-control">
                        <input
                            type="text"
                            placeholder="Search"
                            className="input input-bordered w-24 rounded-xl md:w-auto"
                            value={data.search}
                    ...
                    >
                        <div className="w-10 rounded-full">
                            <img
                                ...
                                src={`https://ui-avatars.com/api/?name=${props.auth.user}`}
                            />
                        </div>
                    </div>
                    <ul
