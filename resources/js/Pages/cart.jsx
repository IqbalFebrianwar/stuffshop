    ...
    return <>
        ...
        <div className="flex gap-x-5 w-full justify-between">
            <section className="w-9/12">
                {
                    product.map(e => <div className="mt-10 shadow rounded-xl p-6 flex gap-x-10">
                ...
                <div className="w-full shadow rounded-xl p-6">
                    <h1 className="text-xl font-semibold">Total Belanja</h1>
                    ...
                    <button className="mt-3 btn btn-block btn-primary rounded-xl" onClick={checkout}>Beli({product.length})</button>
                </div>
            </section>
        </div>
    </>
